...
export class Visualizer {
     ...
     * @param {any} _gain_node
     */
    connect_audio(_gain_node) {
        wasm.visualizer_connect_audio(this.__wbg_ptr, _gain_node);
    }
    destroy() {
        const ptr = this.__destroy_into_raw();
        wasm.visualizer_destroy(ptr);
    }
    /**
     * @param {any} image_data
     */
    load_extra_images(image_data) {
        const ret = wasm.visualizer_load_extra_images(this.__wbg_ptr, image_data);
        if (ret[1]) {
    ...
    /**
     * @param {any} preset
     * @param {number} blend_time
     */
    load_preset(preset, blend_time) {
        const ret = wasm.visualizer_load_preset(this.__wbg_ptr, preset, blend_time);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    constructor(canvas, opts) {
        const ret = wasm.visualizer_new(canvas, opts);
        if (ret[2]) {
     ...
     */
    render(now) {
        wasm.visualizer_render(this.__wbg_ptr, now);
    }
    /**
     * @param {Float32Array} time_domain
     * @param {Float32Array} frequency
     */
    set_audio_data(time_domain, frequency) {
        wasm.visualizer_set_audio_data(this.__wbg_ptr, time_domain, frequency);
    }
    /**
     * @param {number} width
     * @param {number} height
     */
    set_renderer_size(width, height) {
        wasm.visualizer_set_renderer_size(this.__wbg_ptr, width, height);
    }
}
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_checkFramebufferStatus_c4ec991b7df661df: function(arg0, arg1) {
        ...
        __wbg_texImage3D_299fdc3cdb45c985: function() { return handleError(function (arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11) {
...
const VisualizerFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_visualizer_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('khviz_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
